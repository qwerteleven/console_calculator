...
void help_command()
{
  ...
  Updates:
    *Update exists variables with new value or opertion*
    set Name = Expression
  ...
  Operations:
    ...
    A - B -> subtraction
    A % B -> module   *B > 1*
    A / B -> division *can not divede by 0*
    A * B -> multilpication
  ...
  FunctionName:
    *Funtions implemented, this funtions can be recursive for example*
      sin(cos(A));
    ...
    atan(A)   -> arctengent of A
    exp(A)    -> exponential of A
    ln(A)     -> natural logaritm (neperian logaritm) of A
    log10(A)  -> logaritm base 10 of A
    log2(A)   -> logaritm base 2 of A
    pow(A, B) -> A power B 


  Notations of numbers:

    *this calculator do not have types,
      you can use variables indistinctly as integer or float*
